  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
      <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
        <img src={assets.logo3 } alt=""  className="h-10 md:h-12 lg:h-14 object-contain"/>
      ...
      {/* -----mobile menu----- */}
      <div className={`fixed top-0 left-0 w-full h-full bg-white z-20 transform transition-transform duration-300 ${
  showMobileMenu ? 'translate-x-0' : 'translate-x-full'} right-0 top-0 bottom-0 overflow-hidden bg-white transition-all`} >
