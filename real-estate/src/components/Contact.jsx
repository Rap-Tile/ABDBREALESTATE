...
const [result, setResult] = React.useState("");
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "d4e8521d-b9fb-43c3-ba00-881383f400b1");
  ...
  return (
    ...
    initial={{opacity: 0, x:-200}}
      ...
      viewport={{once: true}}
    className='text-center p-6 py-20 lg:px-20 w-full overflow-hidden' id="contact">
      ...
      >With us</span></h1>
      <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Raedy to make a Move? let's Build Your Future together </p>
      <form  onSubmit={onSubmit}  className='max-w-2xl mx-auto text-gray-600 pt-8'>
        <div className='flex flex-wrap'>
            <div className='w-full md:w-1/2 text-left'>
                Your Name
                <input className='w-full border border-gary-300 rounded py-3
        ...
        <div className='my-6 text-left'>
            ...
            <textarea className='w-full border border-gray-300 rounded py-3
                px-4 mt-2 h-40 resixze-none' name='Message' placeholder='Your Message' required></textarea>
        </div>
